...
class ShoppingCart {
    ...
    public double calculateTotal(double productPrice) {
        ...
        return discountStrategy.applyDiscount(productPrice);  // Retornar o total calculado
    }
}
...
public class Main {
    public static void main(String[] args) {
        ...
        double R = cart.calculateTotal(productPrice);

        System.out.println("Total da compra: R$" + R);
